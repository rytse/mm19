...
train_year = 2018
val_year = 2017
train_year = f'{train_year - 1}-{train_year}'
val_year = f'{val_year - 1}-{val_year}'

# Load data
train_raw_teamstats = pd.read_excel('cts.xlsx', sheet_name=train_year)
train_raw_games = pd.read_csv(f'clean_{train_year}_combo.csv')
val_raw_teamstats = pd.read_excel('cts.xlsx', sheet_name=val_year)
val_raw_games = pd.read_csv(f'clean_{val_year}_combo.csv')
